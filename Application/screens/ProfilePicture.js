  ...
  return (
    <View style={{ height: "100%", backgroundColor: Colors.secondary }}>
      ...
      >
        ...
        >
          A profile picture will help your clients recognize you. Consider the
          following picture:
        </Text>
        <Image
          source={require("../assets/images/profile_pic_sample.jpg")}
          style={{
            borderWidth: 1,
            borderColor: "grey",
            marginVertical: hp("5%"),
